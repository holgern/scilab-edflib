function  [smp_in_file]=edf_get_signal_samples(filename,edfsignal)
// Returns the number of available samples of signal edfsignal
// Calling Sequence
// samples=edf_get_signal_samples(path, edfsignal)
// samples=edf_get_signal_samples(edf_header, edfsignal)
// Parameters
...
// samples: number of available samples
// Description
// Returns the number of available samples of signal edfsignal.
// Examples
// samples=edf_get_signal_samples(edf_getpath()+'/demos/demo.bdf',1);
// 
// [header_list]=edfopen_file_readonly(edf_getpath()+'/demos/demo.bdf', 0);
// samples=edf_get_signal_samples(header_list,1);
...
//  Foundation, Inc., 51 Franklin St, Fifth Floor, Boston, MA  02110-1301  USA
    ...
    if (rhs == 2) then 
	  ...
	  smp_in_file=edf_header("smp_in_file")(edfsignal);
	else
	  smp_in_file=edf_header("smp_in_file");
	end
