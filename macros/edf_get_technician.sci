function  [technician]=edf_get_technician(filename)
// Returns the technicians name.
// Calling Sequence
// technician=edf_get_technician(path)
// technician=edf_get_technician(edf_header)
// Parameters
...
// Returns the technicians name.
// Examples
// technician=edf_get_technician(edf_getpath()+'/demos/demo.bdf');
// 
// [header_list]=edfopen_file_readonly(edf_getpath()+'/demos/demo.bdf', 0);
// technician=edf_get_technician(header_list);
...
//  Foundation, Inc., 51 Franklin St, Fifth Floor, Boston, MA  02110-1301  USA
    ...
    technician=edf_header("technician");
endfunction
// ====================================================================
