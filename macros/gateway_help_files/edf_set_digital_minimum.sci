function  edf_set_digital_minimum(edf_handle, edfsignal,  dig_min)
...
// dig_min:Usually, the value -32768 is used for EDF+ and -8388608 for BDF+.  Usually this will be (-(dig_max + 1)).<
// Description
//  Sets the minimum digital value of signal edfsignal.
//  
