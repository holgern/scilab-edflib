function  edf_set_samplefrequency(edf_handle, edfsignal,  samplefrequency)
...
// samplefrequency :  integer containing the samplefrequency of the signal edfsignal
// Description
// Sets the samplefrequency of signal edfsignal.
// 
// This function is required for every signal and can be called only after opening 
// a file in writemode
