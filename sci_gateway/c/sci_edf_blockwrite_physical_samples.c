...
#include "edflib.h"
/* ==================================================================== */
int sci_edf_blockwrite_physical_samples(char *fname)
{
  SciErr sciErr;
...
//   double *dOut = NULL;
  ...
  {
  	Scierror(999,"%s: Wrong type for input argument #%d: A matrix of double expected.\n",fname,2);
  	return 0;
  }
...
/* 
  if ( ( (m2 !=1) && (n2 ==1 ) ) || ( (n2 !=1) && (m2 ==1 ) ) ) 
  {
  	Scierror(999,"%s: Wrong size for input argument #%d: A vector is expected.\n",fname,2);
  	return 0;
  }*/
...
//if ( edfwrite_physical_samples(pdVarOne[0], pdVarTwo) <0)
if ( edf_blockwrite_physical_samples((int)pdVarOne[0], pdVarTwo) <0)
{
     Scierror(999,"Could not write double data\n");
    return 0;
}
