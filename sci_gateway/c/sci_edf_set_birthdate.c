...
#include "edflib.h"
/* ==================================================================== */
int sci_edf_set_birthdate(char *fname)
{
  SciErr sciErr;
...
//  CheckOutputArgument(pvApiCtx,1,1) ;   
  ...
  if ( (m2 !=1) || (n2 !=3 ) ) 
  {
  	Scierror(999,"%s: Wrong size for input argument #%d: A vector with 3(year mounth day ) entries is expected.\n",fname,2);
  	return 0;
  }
...
if ( edf_set_birthdate(pdVarOne[0], pdVarTwo[0] , pdVarTwo[1], pdVarTwo[2]) <0)
{
