...
#include "edflib.h"
/* ==================================================================== */
int sci_edf_set_digital_maximum(char *fname)
{
  SciErr sciErr;
...
if ( edf_set_digital_maximum((int)pdVarOne[0], (int)pdVarTwo[0]-1 , pdVarThree[0]) <0)
{
     Scierror(999,"Could not write digital maximum\n");
    return 0;
}
