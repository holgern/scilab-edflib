...
#include "edflib.h"
/* ==================================================================== */
int sci_edf_set_physical_maximum(char *fname)
{
  SciErr sciErr;
...
if (  edf_set_physical_maximum((int)pdVarOne[0], (int)pdVarTwo[0]-1 , pdVarThree[0]) <0)
{
     Scierror(999,"Could not write physical maximum\n");
    return 0;
}
