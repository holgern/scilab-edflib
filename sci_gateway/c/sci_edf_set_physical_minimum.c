...
#include "edflib.h"
/* ==================================================================== */
int sci_edf_set_physical_minimum(char *fname)
{
  SciErr sciErr;
...
if (  edf_set_physical_minimum((int)pdVarOne[0], (int)pdVarTwo[0]-1 , pdVarThree[0]) <0)
{
     Scierror(999,"Could not write physical minimum\n");
    return 0;
}
