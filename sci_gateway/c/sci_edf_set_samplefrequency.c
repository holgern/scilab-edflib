...
#include "edflib.h"
/* ==================================================================== */
int sci_edf_set_samplefrequency(char *fname)
{
  SciErr sciErr;
...
if (  edf_set_samplefrequency((int)pdVarOne[0], (int)pdVarTwo[0]-1 , pdVarThree[0]) <0)
{
     Scierror(999,"Could not write sample frequency\n");
    return 0;
}
