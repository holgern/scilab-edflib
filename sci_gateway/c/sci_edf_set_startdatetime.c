...
#include "edflib.h"
/* ==================================================================== */
int sci_edf_set_startdatetime(char *fname)
{
  SciErr sciErr;
  ...
  if ( (m2 !=1) || ((n2 !=6)&& (n2!=10) ) ) 
  {
  	Scierror(999,"%s: Wrong size for input argument #%d: A vector with 6(year mounth day hour minute seconds) or 10 (getdate()) entries is expected.\n",fname,2);
  	return 0;
  }
...
if ( edf_set_startdatetime((int)pdVarOne[0], pdVarTwo[0] , pdVarTwo[1], pdVarTwo[2],pdVarTwo[3],pdVarTwo[4],pdVarTwo[5]) <0)
{
...
if ( edf_set_startdatetime((int)pdVarOne[0], pdVarTwo[0] , pdVarTwo[1], pdVarTwo[5],pdVarTwo[6],pdVarTwo[7],pdVarTwo[8]) <0)
{
     Scierror(999,"Could not write string\n");
    return 0;
} 
